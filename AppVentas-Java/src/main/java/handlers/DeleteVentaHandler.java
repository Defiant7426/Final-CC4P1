...
public class DeleteVentaHandler implements HttpHandler {
    private VentasService service;
    private RaftNode raft;

    public DeleteVentaHandler(VentasService service, RaftNode raft) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        boolean success = service.deleteVenta(id);
        if(!success) {
